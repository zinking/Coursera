...
% <visible_state> is a binary matrix of size V * C
...
% with respect to the model parameters. Thus, 
% the returned value is of the same shape as the model parameters, 
...
% Notice that we're talking about the mean over data cases (as opposed to the sum over data cases).
    ...
    rbm_w = hidden_state * visible_state' / C;
