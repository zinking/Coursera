...
function validation_cross_entropy = a4_main(n_hid, lr_rbm, lr_classification, n_iterations)
% first, train the rbm
    ...
    for data_details = reshape({'training', data_sets.training, 'validation', data_sets.validation, 'test', data_sets.test}, [2, 3]),
        ...
        cross_entropies(i) = loss;
        i = i + 1;
    end
    validation_cross_entropy = cross_entropies(2);
