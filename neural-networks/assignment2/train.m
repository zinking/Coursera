...
% Q1: 50,200 all defautl 10 epoch 2.602
% Q2: lr 100, ce fluctuates around large value for both training and
% validation
% Q3: zero, non tranining, 5.522 ln(250)
% Q4: momentum 0.5, 10.0 learns fastest
% Q6: try model B
% Q7: 1000 best
% Q8: 1000 best 
% Q9: try model B (0.5) not 0.0 not 0.5
% Q10: should/might
% Q11: occur rarely 
% Q12: care sensible 4 gram
% Q13: care sensible 4 gram
