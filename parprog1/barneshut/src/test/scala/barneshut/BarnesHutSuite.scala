...
import FloatOps._
  ...
  test("Mass of empty forks should equal center") {
    val q1 = Empty(10,10,10)
    val q2 = Empty(20,10,10)
    val q3 = Empty(10,20,10)
    val q4 = Empty(20,20,10)
    val fk = Fork(q1,q2,q3,q4)
    assert(fk.massX == 15)
    assert(fk.massY == 15)
  }
  ...
  test("insert on to leaf with size <= minimumSize") {
    val b = new Body(123f, 1, 1, 0f, 0f)
    val b1 = new Body(124f, 1, 1, 0f, 0f)
    val quad = Leaf(1, 1, minimumSize/2, Seq(b))
  ...
  test("fork insert should insert recursively") {
    val q1 = Empty(10,10,10)
    val q2 = Empty(20,10,10)
    val q3 = Empty(10,20,10)
    val q4 = Empty(20,20,10)
  ...
  test("SectorMatrix combine should work correctly") {
    val body1 = new Body(5, 5.0f, 5.0f, 0.1f, 0.1f)
    val body2 = new Body(5, 6.0f, 6.0f, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
    boundaries.maxX = 97
    ...
    assert( sm.matrix(0).result.size == 2)
  }
